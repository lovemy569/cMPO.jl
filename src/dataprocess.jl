...
function plot_fig_2(datasets, cv, corr, chi, spectral)
    p1 = plot(xlabel="Temperature", ylabel="specific heat", xlims=(0.0, 2.0), ylims=(0, Inf), foreground_color_legend = nothing, background_color_legend = nothing)
    ...
    p4 = plot(xlabel="ω", ylabel="S(ω)", xlims=(0.0, 3.0), ylims=(0, 3.6), foreground_color_legend = nothing, background_color_legend = nothing)
